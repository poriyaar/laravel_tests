 ...
 <script src="{{ asset('js/dashboard/bootstrap/js/bootstrap.bundle.min.js') }}"></script>
 {{-- <script src="vendor/bootstrap/js/bootstrap.bundle.min.js"></script> --}}

 <!-- Core plugin JavaScript-->
 <script src="{{ asset('js/dashboard/jquery-easing/jquery.easing.min.js') }}"></script>
 ...
 <script src="{{ asset('js/dashboard/datatables/dataTables.bootstrap4.min.js') }}"></script>
